import { StyleSheet, Text, View, TextInput, Button, FlatList, Modal, ImageBackground } from 'react-native'
...
export default function App() {
  ...
  const renderListItem = ({ item }) => (
    <View style={styles.itemList}>
      ...
      <Button title="x" color="#12486B" onPress={() => onSelectItemHandler(item.id)} />
    </View>
  )
  ...
  return (
    <>
      <ImageBackground
        source={require('./assets/logo-vdt2.png')} 
